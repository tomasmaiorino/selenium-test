 ...
 */
public class RunTestServiceTestOld {
    ...
    @Test
    public void submitForm_DoesNotSubmitForm() {
        run.submitForm(mockFirefoxDriver, null);
        verifyZeroInteractions(mockElement, mockFirefoxDriver);
    }
